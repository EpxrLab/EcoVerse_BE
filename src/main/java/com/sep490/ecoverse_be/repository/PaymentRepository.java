...
public interface PaymentRepository extends JpaRepository<Payment, UUID> {
    ...
    java.math.BigDecimal sumAmountByStatusAndDateRange(@Param("status") com.sep490.ecoverse_be.enums.PaymentStatus status, @Param("from") java.time.OffsetDateTime from, @Param("to") java.time.OffsetDateTime to);
    ...
    java.math.BigDecimal sumAmountBySubscriberTypeAndDateRange(@Param("type") com.sep490.ecoverse_be.enums.SubscriberType type, @Param("from") java.time.OffsetDateTime from, @Param("to") java.time.OffsetDateTime to);
    ...
    List<Object[]> findMonthlyRevenueTrend(@Param("from") java.time.OffsetDateTime from);
}
